...
import anthropic
#F
client = anthropic.Anthropic(api_key=os.getenv("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"))
